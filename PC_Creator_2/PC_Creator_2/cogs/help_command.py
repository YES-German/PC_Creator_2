...
class help_command(commands.Cog):
    ...
    async def help_group(self, ctx): 
        ...
        embed_server.add_field(name=f",whois", value="Gives information about the mumber such as join date", inline=False)
        embed_server.add_field(name=f",suggest", value="Can be used to suggest in the #suggestion channel (currently not functional)", inline=False)
