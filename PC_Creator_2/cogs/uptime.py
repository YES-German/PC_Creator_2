...
class uptime(commands.Cog):
    ...
    async def uptime(self, ctx):
        ...
        await ctx.send(f"The bot is online for **{days} days**, **{hours} hours** and **{minutes} minutes**")     
    ...
    async def uptime_slash(self, ctx):
        ...
        minutes, seconds = divmod(remainder, 60)
        days, hours = divmod(hours, 24)
        await ctx.respond(f"The bot is online for **{days} days**, **{hours} hours** and **{minutes} minutes**")         
